...
toast = ToastNotifier()
toast.show_toast(" Jarvis ","The Jarvis Is Now Activated",duration=10,
...
Speak("Let me check all functions........")

for i in trange(100):
    time.sleep(0.2)

Speak("All Good Sir , Now You Can Do Whatever You Want")
Speak("        ")
Speak("Now Tell Me Sir What can i do for you")
...
def TaskExe():
    ...
    def OpenApps():
        ...
        if 'code' in query:
            os.startfile(
                "C:\\Users\ANURAG\AppData\Local\Programs\Microsoft VS Code\Code.exe")

        elif 'telegram' in query:
            os.startfile(
                "C:\\Users\ANURAG\OneDrive\Desktop")
            ...
            webbrowser.open(
                'https://www.google.com/maps/@20.1910045,84.4359044,7z')
    ...
    def Reader():
        ...
        if 'Deep Learning in Python' in name:
            ...
            if 'hindi' in lang:
                ...
                Speak("I Have No Other Languages , Sir")
    ...
    def screenshot():
        ...
        path = takecommand()
        path1name = path + ".png"
        path1 = "C:\\Users\ANURAG\OneDrive\Pictures\Screenshots" + path1name
        kk = pyautogui.screenshot()
        kk.save(path1)
        os.startfile("C:\\Users\ANURAG\OneDrive\Pictures\Screenshots")
    ...
    while True:
        ...
        if 'hello' in query:
            ...
            link = StringVar()
            Label(root, text="Paste Yt Video URL Here",
